<!-- Badges -->
[![Issues](https://img.shields.io/github/issues/aot-technologies/action-deployer-helm)](/../../issues)
[![Pull Requests](https://img.shields.io/github/issues-pr/aot-technologies/action-deployer-helm)](/../../pulls)
[![Apache 2.0 License](https://img.shields.io/github/license/aot-technologies/action-deployer-helm.svg)](/LICENSE)
...
```yaml
- uses: aot-technologies/action-deployer-helm@main
  with:
    ### Required
...
deploys:
  ...
  steps:
    ...
    - name: Deploys
      uses: aot-technologies/action-deployer-helm.yml@main
      with:
        file: frontend/openshift.deploy.yml
